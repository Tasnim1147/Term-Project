...
#             self.piece = self.testPieceWhite
#         elif self.colorOfPiece[:-1] != (1,1,1):
#             self.piece = #self.records["lightPawn"]
#         self.piece.setPos(square)
            
        potentialThreats1 = self.findValidBishopSq(square)
        if self.checkPiece(potentialThreats1, "bishop"):
            print("bthreat")
            return True
        potentialThreats = self.findKnightMoves(square)
        if self.checkPiece(potentialThreats, "knight"):
            print("knighttherae")
            return True
        potentialThreats2 = self.findValidRookSq(square)
