...
#                 print(index)
        ...
        self.square.setColor(color(0, 255, 255)[0],color(0, 255, 255)[1],color(0, 255, 255)[2])
...
#             print(x, y)
            ...
            if self.Handler.getNumEntries() > 0:
                ...
                self.pickedObj = self.pickedObj.findNetTag('squares')
                if not self.pickedObj.isEmpty():
                    x, y, z = self.pickedObj.getX(), self.pickedObj.getY(), self.pickedObj.getZ()
                    self.square.setPos(x, y, z + 0.001)
                    self.pickedObj = None
